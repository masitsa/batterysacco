<section class="panel">
		...
		?>
            ...
            <?php echo form_open_multipart('microfinance/import/do_individual_contacts_import', array("class" => "form-horizontal", "role" => "form"));?>
            ...
            <div class="row">
                <div class="col-md-12">
                    <ul>
                        <li>Download the import template <a href="<?php echo site_url().'microfinance/import/import_individual_contacts_template';?>">here.</a></li>
