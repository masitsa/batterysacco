					...
					<div class="panel-body">
						...
						?>
                        	...
                        	<?php
								...
								if(!empty($individual_number_error))
								{
									?>
                                    <div class="form-group mb-lg has-error">
                                        <label>Payroll/ Member No.</label>
                                        <div class="input-group input-group-icon">
                                            <input name="individual_number" type="text" class="form-control input-lg" value="<?php echo $individual_number;?>" />
                                            <label for="individual_number" class="error"><?php echo $individual_number_error;?></label>
                            ...
                            <?php
								//case of an input error
								if(!empty($individual_phone_error))
								{
									?>
                                    <div class="form-group mb-lg has-error">
                                        <div class="clearfix">
                                        ...
                                        <div class="input-group input-group-icon">
                                            <input name="individual_phone" type="text" class="form-control input-lg" value="<?php echo $individual_phone;?>" />
                                            <label for="individual_username" class="error"><?php echo $individual_phone_error;?></label>
                                            <span class="input-group-addon">
                                                <span class="icon icon-lg">
								...
								else
								{
									...
									<div class="form-group mb-lg">
                                        <div class="clearfix">
                                            <label class="pull-left">Phone</label>
                                            <!-- <a href="#" class="pull-right"> Lost Phone?</a> -->
                                        </div>
                                        <div class="input-group input-group-icon">
                                            <input name="individual_phone" type="text" class="form-control input-lg" value="<?php echo $individual_phone;?>" />
                                            <span class="input-group-addon">
                            ...
                            <?php
								//case of an input error
								if(!empty($individual_email_error))
								{
									?>
                                    <div class="form-group mb-lg has-error">
                                        <div class="clearfix">
                                        ...
                                        <div class="input-group input-group-icon">
                                            <input name="individual_email" type="email" class="form-control input-lg" value="<?php echo $individual_email;?>" />
                                            <label for="individual_username" class="error"><?php echo $individual_email_error;?></label>
                                            <span class="input-group-addon">
                                                <span class="icon icon-lg">
                                                    <i class="fa fa-envelope"></i>
                                                </span>
								...
								else
								{
									...
									<div class="form-group mb-lg">
                                        <div class="clearfix">
                                            <label class="pull-left">Email</label>
                                            <!-- <a href="#" class="pull-right"> Lost Email?</a> -->
                                        </div>
                                        <div class="input-group input-group-icon">
                                            <input name="individual_email" type="email" class="form-control input-lg" value="<?php echo $individual_email;?>" />
                                            <span class="input-group-addon">
							...
							<div class="row">
								...
								<div class="col-sm-4 text-right">
									<button type="submit" class="btn btn-primary hidden-xs">Activate</button>
									<button type="submit" class="btn btn-primary btn-block btn-lg visible-xs mt-lg">Activate</button>
								</div>
							</div>
